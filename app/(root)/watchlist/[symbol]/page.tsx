...
export default async function WatchlistPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-950 text-gray-100">
      ...
      {/* SECTION 1: Ticker Tape */}
      <div className="w-full border-b border-gray-800 bg-gray-900/50 backdrop-blur-md sticky top-[70px] z-10">
         <TradingViewWidget 
            scriptUrl="https://s3.tradingview.com/external-embedding/embed-widget-ticker-tape.js"
            config={TICKER_TAPE_WIDGET_CONFIG(displaySymbols)}
            height={46}
            className="w-full"
         />
      </div>
      ...
      <div className="p-4 md:p-6 lg:p-8 flex flex-col gap-6 max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gradient-to-r from-gray-900 to-gray-900/50 p-6 rounded-2xl border border-gray-800 shadow-2xl">
            <div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="xl:col-span-2 flex flex-col gap-6">
                <div className="bg-gray-900/40 rounded-2xl border border-gray-800 overflow-hidden shadow-xl backdrop-blur-sm p-1">
                    <h1 className="text-2xl px-1 py-2">Your Followed Markets</h1>
                    <TradingViewWidget
